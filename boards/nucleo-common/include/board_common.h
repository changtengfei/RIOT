...
#else
#define LED0_PIN            GPIO_PIN(2, 8)
#define LED0_MASK           (1 << 8)
#define LED1_PIN            GPIO_PIN(2, 6)
#define LED1_MASK           (1 << 6)
#define LED2_PIN            GPIO_PIN(2, 5)
...
#define LED3_ON             (GPIOA->BSRR  = LED3_MASK)
#define LED3_OFF            (GPIOA->BSRR  = (LED3_MASK << 16))
